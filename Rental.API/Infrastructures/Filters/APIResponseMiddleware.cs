...
namespace Rental.API.Infrastructures.Filters
{
    public class ApiResponseMiddleware
    {
            ...
            else
            {
                ...
                using (var bodyStream = new MemoryStream())
                {
                    try
                    {
                        ...
                        if (context.Response.StatusCode == (int)HttpStatusCode.OK || context.Response.StatusCode == (int)HttpStatusCode.Created || context.Response.StatusCode == (int)HttpStatusCode.Accepted)
                        {
        ...
        private string ConvertToJSONString(int code, object content)
        {
            ...
            return JsonConvert.SerializeObject(new ApiResponse(content, code, GetApiVersion()), JSONSettings());
        }
